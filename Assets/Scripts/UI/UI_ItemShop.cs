...
public class UI_ItemShop : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        CreateItemButton(Item.ItemType.AdvancedSword, Item.GetSprite(Item.ItemType.AdvancedSword),d "고급 소드", Item.GetCost(Item.ItemType.AdvancedSword), Item.GetBuyerCost(Item.ItemType.AdvancedSword), 1);
